...
//   createGame("Inglaterra", "x", "Argentina")
// ) +
...
createCard('18/07', 'Disputa do 3º Lugar', '18 HORAS',
  createGame("França", "4x6", "Inglaterra") 
) +

createCard('19/07', 'Grande Final',  '16 HORAS',
   createGame("Espanha", "1x0", "Argentina")
) +
    ...
    <!-- 🥇 BLOCO DO PÓDIO: Agora limpo, usando as classes do CSS! -->
            <div class="card card-podio" style="animation-delay: 2.4s;">
              ...
              <div class="taca-container">
                ...
                <h3>Campeão</h3><div style="display: flex; align-items: center; gap: 4px; width: 85px;"><img src="https://flagcdn.com/w20/es.png" alt="españa"> <span style="color: #f7dd43; font-weight: bold;">🥇España </span></div>
              </div>
        <!-- 2026 -->
        <div style="display: flex; justify-content: space-between; align-items: center; background: #0f172a; padding: 8px 12px; border-radius: 6px; border: 1px solid #1e293b;">
            ...
            <div style="display: flex; align-items: center; gap: 4px; width: 85px;"><img src="https://flagcdn.com/w20/ar.png" alt="argentina"> <span style="color: #d1d1d1;">🥈 Argentina </span></div>
